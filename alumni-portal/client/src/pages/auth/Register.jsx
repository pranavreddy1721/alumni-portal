            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  style={getInpStyle('password', true)}
              ...
              {form.password && (
                <div style={{ display: 'flex', gap: 12, marginTop: 6 }}>
                  <span style={{ fontSize: 11, color: form.password.length >= 8 ? '#059669' : '#94a3b8' }}>
                    {form.password.length >= 8 ? '✅' : '○'} 8+ chars
                  </span>
                  <span style={{ fontSize: 11, color: /(?=.*[A-Z])/.test(form.password) ? '#059669' : '#94a3b8' }}>
                    {/(?=.*[A-Z])/.test(form.password) ? '✅' : '○'} Uppercase
                  </span>
                  <span style={{ fontSize: 11, color: /(?=.*[0-9])/.test(form.password) ? '#059669' : '#94a3b8' }}>
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  style={getInpStyle('confirmPassword', true)}
              ...
              {errors.confirmPassword && (
                <p style={{ color: '#ef4444', fontSize: 12, marginTop: 4 }}>⚠️ {errors.confirmPassword}</p>
              )}
            </div>
                ...
                {ROLES.map((r) => (
                  <button
                    ...
                    style={{
                      ...
                      border: `2px solid ${form.role === r.value ? '#2563eb' : '#e2e8f0'}`,
                      background: form.role === r.value ? '#eff6ff' : '#f8fafc',
                      cursor: 'pointer', textAlign: 'center', transition: 'all 0.15s',
                    }}
                  >
                    <div style={{ fontSize: 22, marginBottom: 4 }}>{r.emoji}</div>
                    <div style={{ fontSize: 12, fontWeight: 700, color: form.role === r.value ? '#2563eb' : '#374151' }}>
                      {r.label}
                    </div>
